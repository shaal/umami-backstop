...
async function writeCookies () {
  ...
  // const loginUrl = execSync(`drush uli --name=admin --browser=0`, { encoding: 'utf8', cwd: config.root });
  const loginUrl = execSync(`ddev . drush uli --name=admin --uri=http://drupal.ddev.local --browser=0`, { encoding: 'utf8' });
